...
@objc public enum FMRadioPlaybackState: Int {
...
open class FRadioPlayer: NSObject {
    ...
    open private(set) var playbackState = FMRadioPlaybackState.stopped {
        didSet {
    ...
    private func shouldGetArtwork(for rawValue: String?, _ enabled: Bool) {
        ...
        FMRadioAPI.getArtwork(for: rawValue, size: artworkSize, completionHandler: { [unowned self] artworlURL in
            DispatchQueue.main.async {
